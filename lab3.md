...
## <p align="center"> Прецендент «Подкинуть карты» </p>
...
## <p align="center"> Прецендент «Отбить карты» </p>
...
| :---        | :--- |
| Ссылки      | Преценденты: «Отбить карты», «Взять карты» |
...
## <p align="center"> Прецендент «Взять карты» </p>
...
## <p align="center"> Прецендент «Добор карт» </p>
...
## <p align="center"> Прецендент «Завершение игры» </p>
